...
class Scene1 extends Scene {
	...
	create() {
		...
		// this.newBox( { width: 200, height: 200, last: this.base_cube } )
...
//luces
	...
	newBox ({width,height,last}) {
		const actual_box = new Box( { width, height, last } )
	...
	events () {
		...
		Observer.on( EVENTS.CLICK, (msg) => {
			// this.newBox( { width: 200, height: 200, last: this.getLastBox() } )
		...
		Observer.on( EVENTS.STACK, ( new_box ) => {
			...
			console.log( actual_base_cut.getBase() );
			//Bloque nuevo
			this.newBox( {
